...
phssr.makeHardCodedStyleTag = function(reporterOptions){
    ...
    styleTag+= "td.desc-col{width:400px;}th.desc-col{width: 400px;}";
    styleTag+= "td.status-col{width:75px;}th.status-col{width: 75px;}";
    styleTag+= "td.browser-col{width:100px;}th.browser-col{width: 100px;}";
    styleTag+= "td.os-col{width:100px;}th.os-col{width: 100px;}";
    styleTag+= "td.msg-col{width:450px;}th.msg-col{width: 450px;}";
    styleTag+= "table.header{background-color: gray; color: #fff;margin-left:20px;}";
    styleTag+= ".traceinfo{position: fixed;top: 0; bottom: 0;left: 0;right:0;background: rgba(0,0,0,0.8);z-index: 99999;opacity:0;-webkit-transition: opacity 400ms ease-in;transition: opacity 400ms ease-in;pointer-events: none;overflow:scroll;}";
    styleTag+= ".traceinfo.visible{opacity:1;pointer-events: auto;}";
    styleTag+= ".traceinfo > div{width: 95%;position: relative;margin: 2% auto;padding: 5px 20px 13px 20px;background: #fff;}";
